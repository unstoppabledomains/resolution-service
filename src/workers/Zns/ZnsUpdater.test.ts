...
describe('ZnsWorker', () => {
  ...
  it.only('should parse the fake transaction', async () => {
    ...
    expect(domainFromDb?.ownerAddress).eq("0x0c7b9630f75423ca9efba2a386d0bc6a0292702e");
    expect(domainFromDb?.resolver).eq(null);
    expect(domainFromDb?.node).eq("0xd81a54e6c75997b2bbd27a0c0d5afa898eae62dbfc3c178964bcceea0c009b3c");
